<?php 
####################################################################################
# Модуль выводит на экран результат поиска вхождения части слова во всей базе      #
...
//       if ($pos === false) {echo "<br>Строка '$String' не найдена в строке '$StringBig'"; continue; } 
         if ($pos)   
            {
...
if ($f == 0) print "<p></p><center><font color='Red' ><strong>НАЙДЕНО НА САЙТЕ СИСТЕМЫ  </strong></font></center>";         
if ($Strings_Number >0)
   {
   	print "<p></p><font color='Blue'><strong>ТАБЛИЦА $All_Tables_Names[$f]:  КОЛИЧЕСТВО СТРООК - </strong></font>
